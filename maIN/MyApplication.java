    ...
    public void start(){
        while (true){
            ...
            try {
                ...
                switch (option){
                    case 1: getMedicineByNameMenu();break;
                    case 2: getMedicineByIdMenu();break;
                    case 3: addMedicineMenu();break;
                    case 4: removeMedicineMenu();break;
                    case 5: getAllMedicine(); break;
                    default:break;
                }
            }catch (Exception e){
